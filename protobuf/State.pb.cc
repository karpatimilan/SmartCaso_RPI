...
PROTOBUF_CONSTEXPR State::State(
    ...
    /*decltype(_impl_.currentstate_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static ::_pb::Metadata file_level_metadata_State_2eproto[1];
...
const uint32_t TableStruct_State_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::State, _impl_.currentstate_),
};
...
const char descriptor_table_protodef_State_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013State.proto\"\035\n\005State\022\024\n\014currentState\030\001"
  " \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_State_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_State_2eproto = {
    false, false, 52, descriptor_table_protodef_State_2eproto,
    "State.proto",
    &descriptor_table_State_2eproto_once, nullptr, 0, 1,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_currentstate();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "State.currentState"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* State::_InternalSerialize(
  ...
  if (!this->_internal_currentstate().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_currentstate().data(), static_cast<int>(this->_internal_currentstate().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "State.currentState");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_currentstate(), target);
  }
...
void State::InternalSwap(State* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.currentstate_, lhs_arena,
      &other->_impl_.currentstate_, rhs_arena
  );
}
